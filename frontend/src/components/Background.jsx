    ...
    <>
      ...
      >
        <div
          ...
          className="relative left-1/2 aspect-[1155/678] w-[14rem] -translate-x-1/2 rotate-[10deg] bg-gradient-to-tr from-[#ff80b5] via-[#c599ff] to-[#9089fc] opacity-35 sm:w-[100rem]"
        />
      </div>
