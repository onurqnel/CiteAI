      ...
      <div className="py-12 lg:pb-18">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="mt-12 text-8xl text-gray-900">CiteAI</h1>

            <p className="mt-12 text-2xl font-medium text-pretty text-gray-600 flex items-center justify-center gap-2">
              Powered by OpenAI&nbsp;API
              <img src="/openai.png" alt="OpenAI Logo" className="h-6 w-6" />
            </p>
            <div className="mt-16 flex items-center justify-center gap-x-8">
              <a
                href="#"
                className="mt-8 flex items-center justify-center rounded-full bg-gray-800 px-6 py-2 text-lg font-semibold text-white shadow-lg transition hover:bg-violet-800 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-indigo-300"
              >
                Get&nbsp;Started
              </a>
            </div>
